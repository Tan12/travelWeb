...
<body>
        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="/travelWeb/index.php/Admin/Index/manageTips">管理攻略</a></li>
                ...
                <div class="col-lg-9 col-md-10 col-md-offset-1">
                    <div id="showTips">
                        <div id="tips">
                            <?php if(is_array($result)): foreach($result as $key=>$v): ?><div class="post-preview">
                                    <a href="/travelWeb/index.php/Admin/Index/message?id=<?php echo ($v["tips_id"]); ?>" target="_blank">
                                        <h2 class="post-title"><?php echo ($v["tips_title"]); ?></h2>
                                        <div class="post-content">
                                            <?php echo (mb_substr($v["tips_content"],0,100,'utf-8')); ?>...
                                        </div>
                                    </a>
                                    <p class="post-meta">
                                        <?php echo ($v["tips_author"]); ?>发布于<?php echo ($v["tips_time"]); ?> 
                                        <a class="del" href="##" name="<?php echo ($v["tips_id"]); ?>">删除</a>
                                    </p>
                                    <hr>
                    ...
                    <form id="addTips"  class="form-horizontal" method="post">
                        <div class="form-group">
                            <label>标题：</label>
                            <input class="form-control" type="text" id="tips-title" name="title" placeholder="请输入标题" />
                        </div>
                        <div class="form-group">
                            <label>标签：</label>
                            <input class="form-control" type="text" id="tags" name="tags" placeholder="请输入标签" />
                            <small class="text-danger">标签以“，”隔开</small>
                        </div>
                        <div class="form-group">
                            <label>内容：</label>
    ...
    <script src="<?php echo (ADMIN_PUBLIC); ?>/js/managetips.js"></script>
</body>
</html>