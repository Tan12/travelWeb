...
<head>
	...
	<link href="<?php echo (HOME_PUBLIC); ?>/css/tips.css" type="text/css" rel="stylesheet" />
	<title>旅游攻略</title>
</head>
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/travelWeb/index.php/Home/Index/tips">旅游攻略</a></li>
			...
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1" id="showTips">
				<div id="cont" class="hide-div">
					<?php if(is_array($result)): foreach($result as $key=>$v): ?><div class="post-preview hide-div">
							<a href="/travelWeb/index.php/Home/Index/message?id=<?php echo ($v["tips_id"]); ?>" target="_blank">
							...
							<p class="post-meta">
								<span class="glyphicon glyphicon-user"><?php echo ($v["tips_author"]); ?></span>
								<span class="glyphicon glyphicon-time"><?php echo ($v["tips_time"]); ?></span>
							</p>
							<hr>
    ...
    <script src="<?php echo (HOME_PUBLIC); ?>/js/tips.js"></script>
</body>
</html>