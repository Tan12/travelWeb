...
<body>
				...
				<div class="without-side">
					...
					<div class="user-info">
						<h1>
							...
							<span id="user-id" class="hide"><?php echo ($user["user_id"]); ?></span>
							<span id="if-follow" class="hide"><?php echo ($user["flag"]); ?></span>
							<small>
								<a href="##" id="follow">
    ...
    <script src="<?php echo (HOME_PUBLIC); ?>/js/user.js"></script>
</body>
</html>