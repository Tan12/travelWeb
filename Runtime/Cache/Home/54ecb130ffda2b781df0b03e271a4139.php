...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/travelWeb/index.php/Home/Index/views">景点介绍</a></li>
			...
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1" id="showTips">
				<div id="cont" class="hide-div">
					<?php if(is_array($result)): foreach($result as $key=>$v): ?><div class="post-preview hide-div">
                            <h2 class="post-title">
                                <a href="/travelWeb/index.php/Home/Index/view?id=<?php echo ($v["sights_id"]); ?>" target="_blank">   
    ...
    <script src="<?php echo (HOME_PUBLIC); ?>/js/views.js"></script>
</body>
</html>